...
const Approach = () => {
  ...
  return (
    <main  id="services" className=' min-h-screen flex flex-col justify-center items-center m-auto'>
        ...
        <div className='header-section'>
            <p className='heading'>Our ayurvedic approach</p>
        ...
        <div className=' sm:w-10/12 w-full sm:flex flex-wrap gap-2 items-center justify-center'>
          {
           array.map((item)=>(
            <div className=' bg-yellow-50 sm:w-1/5 h-[250px] m-8 sm:m-1 border-t-2 border-green-800 rounded-3xl p-8 flex flex-col justify-center items-center shadow-xl'>
