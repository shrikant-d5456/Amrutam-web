...
const PlayStoreApp = () => {
  return (
    <main className=' bg-yellow-50'>
      ...
      <p className=' heading'>Amrutam home App</p>
      <p className=' text-center font-light '>The Amrutam Home App is your one-stop app for all things Ayurveda! Apart from mimicking the significant characteristics of our website, this app offers a wide range of additional features.</p>
      <p className=' font-semibold text-center'>Get a diet & lifestyle consultation with ayurvedic experts across the globe </p>
      ...
      <div className=' sm:w-1/2 justify-center items-center m-auto'>
        <img src="https://s3-alpha-sig.figma.com/img/8c1b/9dae/35e943f21e799601f8a2e985c6f1894f?Expires=1735516800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=D~msjqUVtGyvIXK~vJnh4fCFKzh9dZvKUBs2iH68Je0TeZ05BZSrZ3gCOZ~nf~Wy5QYu5M~oYWMb-VcSNxydsQdb2JsDd1z0mWee9Q~rdKPTecKHpnN378vY8RtH3ZnmYb0wFuePeC2BL9lkcWUl4DXeq7nd0byvlLHgQi9uwUS6U~MakQ300YhQwS6gWgcW-m5yiZ-C~jrCrKlXAodTvfJ4FmDXvHJDEnPLFpoFchy975~-dhbni9YM0y2POYOVy-dpQ6HjJ8KHd9j4gvI-DKQbs7i0ch3ErCWwXkyIvNwSEOutP7Q2c3rHOfqhEfeCgeYG7UkNdXW0aNUWPqARCg__" alt="" />
      </div>
